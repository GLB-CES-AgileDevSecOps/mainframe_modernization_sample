      ...
      *
        01 EMPMAPCI.
          ...
          02 FILLER           PIC X(2).
          02 ACTIONI              PIC X(1).
          02 EMPCDL              PIC S9(4) COMP.
          02 EMPCDF              PIC X.
          02 FILLER REDEFINES EMPCDF.
            05 EMPCDA              PIC X.
          02 FILLER           PIC X(2).
          02 EMPCDI              PIC X(8).
          02 EMPNML              PIC S9(4) COMP.
          02 EMPNMF              PIC X.
          02 FILLER REDEFINES EMPNMF.
            05 EMPNMA              PIC X.
          02 FILLER           PIC X(2).
          02 EMPNMI              PIC X(50).
          ...
          02 FILLER           PIC X(2).
          02 GRSPAYI              PIC X(11).
          02 LOCL              PIC S9(4) COMP.
          02 LOCF              PIC X.
          02 FILLER REDEFINES LOCF.
            05 LOCA              PIC X.
          02 FILLER           PIC X(2).
          02 LOCI              PIC X(50).
        ...
        01 EMPMAPCO REDEFINES EMPMAPCI.
          02 FILLER                PIC X(12).
          02 FILLER                PIC X(3).
          02 TITLEC              PIC X.
          02 TITLEH              PIC X.
